...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var selectSample = filteredSample[0];
    // Deliverable 3: 2. Create a variable that holds the first sample in the metadata array.
    var selectMeta = filteredmeta[0];
    // Deliverable 1: 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
    var otu_ids = selectSample.otu_ids;
    var otu_labels = selectSample.otu_labels;
    var sample_values = selectSample.sample_values;
    // Deliverable 3: 3. Create a variable that holds the washing frequency.
    var washfreq = selectMeta.wfreq;
    ...
    var gaugeLayout = {
      title: "Belly Button Washing Frequency<br><span style='font-size:0.8em'>Scrubs per Week</span>"
    }
